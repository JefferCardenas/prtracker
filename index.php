        ...
        <form method="post" id="frmPedido">
            <section class="containerSeleccion" id="containerSeleccion">
                <div id="containertamano" class="containertamano">
                    ...
                    <div class="containerChecks">
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="rdoz" id="8radio" value="8" hidden>
                            <label class="form-check-label boxCheck" for="8radio">
                                8 oz
                            </label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="rdoz" id="12radio" value="12" hidden>
                ...
                <div id="containerlicor" class="containerlicor">
                    ...
                    <div class="containerChecks">
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="rdlicor" id="chksi" value="true" hidden>
                            <label class="form-check-label boxCheck" for="chksi">
                                SI
                            </label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="rdlicor" id="chkno" value="false" hidden>
                ...
                <div class="containerbotonAgregar" id="containerBotonAgregar">
                    <button type="button" class="btnPR" data-bs-toggle="modal"
            ...
            <!-- Modal -->
            <div class="modal fade" id="modalConfirmacion" tabindex="-1" aria-labelledby="modalConfirmacion"
                aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h1 class="modal-title fs-5" id="exampleModalLabel">Confirmar seleccion</h1>
